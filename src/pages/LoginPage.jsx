      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center px-6 h-16 w-full max-w-7xl mx-auto">
          ...
          <div className="flex gap-4">
            ...
            <Link to="/register" className="text-slate-600 font-medium hover:text-blue-800 transition-colors">
              Đăng ký
            </Link>
          </div>
        </div>
      ...
      <main className="flex-grow flex items-center justify-center px-4 pt-20 pb-12">
        <div className="w-full max-w-xl">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
            {/* Branding Side */}
            <div className="hidden md:flex md:w-2/5 bg-gradient-to-br from-blue-600 to-blue-700 p-8 flex-col justify-between text-white relative overflow-hidden">
              <div className="z-10">
                ...
                <h2 className="text-2xl font-bold leading-tight">Chào mừng trở lại!</h2>
                <p className="text-sm mt-4 text-blue-100">Đăng nhập để theo dõi và quản lý các báo cáo sự cố của bạn.</p>
              </div>
              ...
              <div className="z-10 space-y-3 mt-8">
                <div className="flex items-center gap-3 text-sm text-blue-100">
                  ...
                  <span>Phản hồi nhanh trong 24h</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-blue-100">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-grow p-8 md:p-10">
              <header className="mb-8">
                ...
                <p className="text-slate-500 text-sm">Nhập thông tin để truy cập tài khoản của bạn</p>
              </header>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-4 py-3.5 bg-slate-50 rounded-xl border-2 border-transparent focus:border-blue-500 focus:bg-white focus:ring-0 transition-all text-slate-800 placeholder:text-slate-400"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-12 py-3.5 bg-slate-50 rounded-xl border-2 border-transparent focus:border-blue-500 focus:bg-white focus:ring-0 transition-all text-slate-800 placeholder:text-slate-400"
                    />
                    <button
                      type="button"
